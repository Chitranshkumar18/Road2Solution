        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2.5">
            ...
            >
              ...
              <span>Location Assignment Hub</span>
            </Link>
            <span className="px-3 py-2 rounded-xl text-xs font-mono font-bold bg-amber-500/10 text-amber-300 border border-amber-500/20">
              ...
              <div className="flex items-start gap-4 min-w-0">
                ...
                <div className="min-w-0 space-y-1">
                  ...
                  <div className="flex items-center gap-2 pt-0.5">
                    <span className={`px-2 py-0.2 rounded text-[10px] font-bold border ${entity.badgeClass}`}>
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <div className="flex items-center gap-3 text-xs text-slate-300 mt-2 font-mono">
                <span>Location: {formatDisplayAddress(selectedIssue.location?.address, selectedIssue.location)}</span>
              </div>
            </div>

            {/* Current Responsibility */}
            <div className="p-3.5 rounded-xl bg-slate-950 border border-slate-800 space-y-1">
              <span className="text-[10px] font-mono uppercase text-slate-500 block">Current Assignment / Responsible Party</span>
              <p className="text-xs text-indigo-300 font-bold">
                {selectedIssue.assignedOrgName 
                  ? `🏢 Assigned Org: ${selectedIssue.assignedOrgName}` 
                  : selectedIssue.responsibleType === 'PUBLIC_INDIVIDUAL' 
                  ? `🌟 Public Volunteer: ${selectedIssue.responsibleName}` 
                  : '⚡ Unassigned (Awaiting Organization Assignment)'}
              </p>
            </div>
